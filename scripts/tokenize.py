...
SPY = [
    ...
    (7,'PRINT:PRINT "  STEER WITH ARROW KEYS/JOYSTICK"'),
    (8,'PRINT "  FIRE BUTTON = SHOOT RED CARS"'),
    (9,'PRINT "  DODGE THEM - YOU HAVE 3 LIVES"'),
    (10,'PRINT:PRINT "  MOVE OR FIRE TO START"'),
    (11,'Q=PEEK(56320):W=PEEK(56321):IF (Q AND 31)=31 AND (W AND 31)=31 THEN 11'),
    ...
    (60,'Q=PEEK(56320):W=PEEK(56321):GET K$'),
    (70,'IF ((Q AND 4)=0 OR (W AND 4)=0 OR K$="A") AND P>14 THEN POKE B+R+P,32:P=P-1'),
    (80,'IF ((Q AND 8)=0 OR (W AND 8)=0 OR K$="D") AND P<26 THEN POKE B+R+P,32:P=P+1'),
    (90,'IF ((Q AND 16)=0 OR (W AND 16)=0 OR K$=" ") AND F=P THEN POKE B+E*40+F,32:S=S+5:E=1:F=14+INT(RND(1)*13)'),
    ...
    (310,'PRINT:PRINT "  MOVE OR FIRE TO PLAY AGAIN"'),
    (320,'Q=PEEK(56320):W=PEEK(56321):IF (Q AND 31)=31 AND (W AND 31)=31 THEN 320'),
    (330,'RUN'),
]
